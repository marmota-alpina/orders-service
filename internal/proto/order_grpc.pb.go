...
type OrderServiceClient interface {
	...
	GetOrderById(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*Order, error)
...
func (c *orderServiceClient) GetOrderById(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*Order, error) {
	out := new(Order)
...
type OrderServiceServer interface {
	...
	GetOrderById(context.Context, *OrderRequest) (*Order, error)
...
func (UnimplementedOrderServiceServer) GetOrderById(context.Context, *OrderRequest) (*Order, error) {
